...
class Backend extends CI_Controller {
    ...
    public function services()
    {
        ...
        $this->load->model('customers_model');
        $this->load->model('services_model');
        $this->load->model('services_meta_model');
        $this->load->model('settings_model');
        $this->load->model('user_model');
        ...
        $view['meta'] = $this->services_meta_model->get_batch();
        $this->set_user_data($view);
    ...
    public function ehr()
    {
        $this->session->set_userdata('dest_url', site_url('backend/ehr'));
        ...
        $view['base_url'] = $this->config->item('base_url');
        $view['ehr_url'] = site_url('backend/ehr');
        $view['user_display_name'] = $this->user_model->get_user_display_name($this->session->userdata('user_id'));
        $view['active_menu'] = PRIV_SERVICES;
        $view['company_name'] = $this->settings_model->get_setting('company_name');
        $view['date_format'] = $this->settings_model->get_setting('date_format');
        ...
        $this->load->view('backend/header', $view);
        $this->load->view('backend/ehr', $view);
        $this->load->view('backend/footer', $view);
    }
