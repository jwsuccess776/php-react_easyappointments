...
// installer
$route['api/v1/provision']['get'] = 'api/v1/provision/install';
$route['api/v1/provision']['post'] = 'api/v1/provision/install';

// new appointment
$route['api/v1/appointment']['get'] = 'api/v1/provision/appointment';
$route['api/v1/appointment']['post'] = 'api/v1/provision/appointment';
